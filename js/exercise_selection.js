document.addEventListener("DOMContentLoaded", function () {
  ...
  const allEquipment = ["TRX", "Dumbbells", "Kettlebell", "Barbell", "Box", "Jump Rope", "Battle Rope", "Resistance Bands", "Medicine Ball", "Pull-up Bar"];
  ...
  function showExercisesByCategory(category) {
      ...
      let categoryExercises = exerciseDatabase ? exerciseDatabase.filter(exercise => 
